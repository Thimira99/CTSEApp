...
export default function insertDishes(props) {
    ...
    const add = () => {
        ...
        var url = "http://192.168.198.79:8080/user/createDishesCard";
        // var data = {
        //     "id": title,
    ...
    return (
        <View style={styles.container}>
            <Text style={styles.des}>Insert Dish</Text>
            ...
            <View style={styles.inputView}>
                <TextInput
                    ...
                    onChangeText={(value) => handleChange('categoryid', value)}
            ...
            <TouchableOpacity style={styles.addBtn} onPress={() => {
                navigation.navigate("insertSubDish");
            }}>
